...
public class User {
    ...
    // 2. Data Validation: Entity classes often include validation constraints to ensure data integrity, as seen in this example.
    ...
    // 4. Entity Relationships: Entities can establish relationships with other entities, such as the one-to-many relationship with `Reservation` entities (not shown in this code). This allows for modeling complex data structures.
    ...
    // In this case, the `User` entity is used for representing user data, including validation constraints to ensure data quality and integrity.
}
