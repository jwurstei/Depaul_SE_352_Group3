...
public class VehicleService {
  ...
  public List<Vehicle> findVehiclesByMake(String vehicleMake) {
    List<Vehicle> vehicles = vehicleRepo.findAllByVehicleMake(vehicleMake);
    return vehicles;
  }

  @Transactional
  public List<Vehicle> findVehiclesByModel(String vehicleModel) {
    List<Vehicle> vehicles = vehicleRepo.findAllByVehicleModel(vehicleModel);
    return vehicles;
  }

  @Transactional
  public List<Vehicle> findVehiclesByYear(int vehicleYear) {
    List<Vehicle> vehicles = vehicleRepo.findAllByVehicleYear(vehicleYear);
    return vehicles;
  }
